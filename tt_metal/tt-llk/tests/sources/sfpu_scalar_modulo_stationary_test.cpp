...
// Test-only exponent-stationary magnitude reducer.  The output is the
// nonnegative remainder in the normalized exponent-111 frame; this file does
// not restore signs or construct physical normal/subnormal encodings.
...
void run_kernel(RUNTIME_PARAMETERS params)
{
    ...
    sfpu::init_scalar_modulo_stationary_research(SCALAR_NORMALIZED_DIVISOR, SCALAR_RECIPROCAL_UP);
